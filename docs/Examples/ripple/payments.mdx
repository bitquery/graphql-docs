---
title: "Ripple XRP Payments API Examples — Bitquery GraphQL"
description: "Query XRP Ledger payments with Bitquery GraphQL. Get the latest payments on Ripple, filter by sender or receiver address, and retrieve payment amounts in USD."
keywords: [Ripple, XRP, payments, XRP Ledger, Bitquery, GraphQL, Ripple payments, Ripple API]
---
...
## Get Latest XRP Ledger Payments on the Ripple Network
...
## Get XRP Ledger Payments Involving a Specific Ripple Address
