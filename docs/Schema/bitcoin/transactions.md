...
-   `maximum`: returns maximum for selected measurable field of Bitcoin transaction
-   `minedValue`: returns total mined value of transaction
-   `minedValueDecimal`: returns mined value as decimal
-   `minimum`: returns minimum for selected measurable field of Bitcoin transaction
