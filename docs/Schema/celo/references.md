---
title: "Celo References API"
description: "Query Celo schema references data using Bitquery GraphQL API. Get reference data and lookup tables for this network schema."
keywords: ["Celo API", "Celo References", "Bitquery", "GraphQL"]
---
